...
- Parameter store tracks amplitude, frequency, warp, ridge strength, X/Y/Z offsets, per-axis scaling, wireframe, and autorotation so UI + scene stay in sync.
...
- **Sliders:** Displacement (amplitude), Frequency, Roughness (octave falloff), Warp (domain warp), Ridge sharpening, Clamp Outside/Inside, Offset X/Y/Z, Scale Z, and Seed all map directly to the modifier pipeline.
