...
- Parameter store tracks amplitude, frequency, warp, ridge strength, X/Y/Z offsets, wireframe, and autorotation so UI + scene stay in sync.
...
- **Sliders:** Displacement (amplitude), Frequency, Roughness (octave falloff), Warp (domain warp), Ridge sharpening, Clamp Outside/Inside, Offset X/Y/Z, and Seed all map directly to the modifier pipeline.
